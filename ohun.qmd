...
<img src="images/analysis_workflow.png" alt="automatic signal detection diagram" width="500" height="450"/>
...
# diagnose
diagnose_detection(reference = lbh1_reference, detection = lbh1_reference)[, c(1:3, 6:8)]
...
# diagnose
diagnose_detection(reference = lbh1_reference, detection = lbh1_detection)[, c(1:3, 6:8)]
...
# diagnose
diagnose_detection(reference = lbh1_detection, detection = lbh1_reference)[, c(1:3, 6:8)]
...
4.  Macmillan, N. A., & Creelman, C.D. (2004). Detection theory: A user's guide. Psychology press.
